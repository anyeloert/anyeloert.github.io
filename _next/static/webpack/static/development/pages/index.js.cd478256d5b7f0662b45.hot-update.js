...
var Precio = function Precio(props) {
  ...
  var porcentaje1Semana = (precioActual - precio1Semana) * 100 / precioActual;
  var porcentaje1Hora = (precioActual - precio1Hora) * 100 / precioActual;
  var porcentaje1Dia = (precioActual - precio1Dia) * 100 / precioActual;
  return __jsx("div", {
  ...
  }, "Precio Actual: ", precioActual.toFixed(2)), __jsx("ul", {
  ...
  }, "\xDAltima Hora: ", porcentaje1Hora.toFixed(2), "%"), __jsx("p", {
    className: "card-text",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
  ...
  }, "\xDAltimas 24 Horas: ", porcentaje1Dia.toFixed(2), "%"), __jsx("p", {
    className: "card-text",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
  ...
  }, "\xDAltimos 7 d\xEDas: ", porcentaje1Semana.toFixed(2), "%"))));
};
...
//# sourceMappingURL=index.js.cd478256d5b7f0662b45.hot-update.js.map